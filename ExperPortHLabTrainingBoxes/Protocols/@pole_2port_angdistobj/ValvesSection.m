...
function [x, y] = ValvesSection(obj, action, x, y)
   ...
   switch action
    case 'init',
      ...
      EditParam(obj, 'LWaterValveTime', '0.12435', x, y);  next_row(y); % Edited by JK 12/30/2015 for L-R integration
      EditParam(obj, 'RWaterValveTime', '0.09511', x, y);  next_row(y); % Edited by JK 12/30/2015
